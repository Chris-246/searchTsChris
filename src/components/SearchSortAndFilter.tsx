...
export function SearchSortAndFilter<T> (props: PropsWithChildrenFunction<ISearchSortAndFilterProps<T>, T>) {
    const { title, dataSource, searchProperties, initialSortProperty, initialFilterProperties, initialSearchQuery, children } = props;
    ...
    <>
        <h2>{title}</h2>
          ...
          />
          <Sorters dataSource={dataSource} setSortProperty={(sortProperty) => {
              setSearchSortAndFilterState({
                ...searchSortAndFilterState,
                sortProperty
            })
          }} />
          <Filters dataSource={dataSource} filterProperties={filterProperties} setFilterProperties={(filterProperties) => {
              setSearchSortAndFilterState({
                ...searchSortAndFilterState,
                filterProperties
            })
